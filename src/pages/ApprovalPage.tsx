import { Button, Card, Descriptions, Input, message, Modal, Space, Table, Tag } from "antd";
    ...
    return (
        <div>
            ...
            <Card styles={{ body: { padding: 12 } }}>
                <Table<RequestRecord> rowKey="id" dataSource={data} pagination={{ pageSize: 10 }} columns={[
